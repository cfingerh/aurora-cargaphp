...
if(isset($_GET['idDiv']) && isset($_GET['tip'])){
	$lista = getDatosTramo($_GET['idDiv'],$_GET['tip']);
}

?>
<!doctype html>
<html><head>
    <title>Reporte de tareas pendientes por Divisi&oacute;n/Unidad</title>
...
<div class="fw-container">
  <div class="fw-body">
    ...
    <div class="content">
      <h1 align="center" class="page_title">Reporte tareas <?php if($_GET['tip']=='p'){echo 'pendientes';}else{ echo 'finalizadas';}?> <?php echo $_GET['idDiv']?> </h1><?php if($_GET['idDiv']!=''){ ?><a href="det_nivel1.php?idDiv=&tip=p">[ver todas las &aacute;reas]</a><?php }?>
    ...
    <div class="collapse navbar-collapse navbar-ex6-collapse">
      <ul class="nav navbar-nav">
			<li <?php if($_GET['tip']=='f'){echo 'class="active"';}?>><a href="det_nivel1.php?idDiv=&tip=f" >Resumen tareas finalizadas</a></li>
			<li <?php if($_GET['tip']=='p'){echo 'class="active"';}?>><a href="det_nivel1.php?idDiv=&tip=p" >Resumen tareas pendientes</a></li>          
      </ul>
    </div><!-- /.navbar-collapse -->
  </nav>	  <br><br>
	<div id="tablaHechos">

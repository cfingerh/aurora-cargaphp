...
</h2><div id="mynetwork" ></div>
       </td>
	  <td width="50%"><div id="detalleNodo" style="width:auto; height:100%; overflow:scroll; word-wrap: break-word;"></div></td>
  </tr>
</table>
<h2>
    Timeline eventos de la industria 
</h2>
<div id="timelineMacro" style="width:100%; padding:10px"></div>
<br></br>
<div id="detalleHecho" style="width:640px; height:480px; overflow:scroll; word-wrap: break-word;" title="Informaci&oacute;n de evento"></div>
<br></br>

<div id="listaEv" style="width:100%; padding:10px">
...
<div id="listaNodos" style="width:100%; padding:10px">

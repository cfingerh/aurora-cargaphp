...
function saveUsers($_notificados, $_idProc){
	...
	$mensaje = 'Estimado usuario:</br></br>
			...
			Para revisarla, por favor diríjase a la <strong>Bandeja de Notificaciones y Seguimiento</strong> del sistema 
			
			<a href="http://sistemas.scj.cl/sgdp/"> Sistema de gestión documental y de procesos</a></br></br>

    ...
    <div id="lado_izquierdo">
      ...
      <div id="menu_lateral">
        <ul>
		  ...
		  <li ><a href="repges.php">Carpetas pendientes</a></li>
        ...
        <div id="listado" class="listado" style="width:1000px">
          ...
          <form id="formBuscar"  enctype="multipart/form-data" method="post" action="logica/buscar_carpeta.php">
            <table border="0" cellspacing="1" cellpadding="0">
			  <tr>
                <td width="124" bgcolor="#E6E6E6">Emisor:</td>
                <td colspan="2" bgcolor="#E6E6E6"><select name="cbxRem" id="cbxRem" style="width:245px" >
			  ...
			  <tr>
                ...
                <td colspan="2" bgcolor="#E6E6E6"><table width="200">
                  <tr>
                    <td><label>
                      <input name="radioEstado" type="radio" value="t" checked="checked" />
                      Todas</label></td>
                  </tr>
                  <tr>
                    <td><label>
                      <input type="radio" name="radioEstado" value="o" />
                      Abiertas</label></td>
                  </tr>
                  <tr>
                    <td><label>
                      <input type="radio" name="radioEstado" value="a" />
                      Archivadas</label></td>
                  </tr>
                </table>
                </td>
